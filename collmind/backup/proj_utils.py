...
MODEL_NAMES = {
    ...
    "Gatewaypundit": 'gatewaypundit_new_s4_r19_h425_u30_t10',
...
def collect_sampled_data_new(collection_name: str, size: int, seed: int, start_date=datetime(2016, 4, 1), end_date=datetime(2017, 4, 1), select_columns=None, mode='new', threshold=5):
    """Samples data, collects the respective sentence embeddings, and queries additional information from the database.
